const about = {
  badge: "El equipo tras la innovación",
  ...
  mission: {
    ...
    paragraph1:
      "Democratizar el acceso a diagnósticos médicos de alta precisión mediante tecnología de inteligencia artificial avanzada, mejorando la calidad de vida de millones de personas en todo el mundo.",
    paragraph2:
      "Creemos que cada paciente merece el mejor diagnóstico posible, independientemente de su ubicación geográfica o recursos disponibles.",
    alt: "Equipo Médico",
  },
  values: {
    title: "Nuestros Valores",
    subtitle:
      "Los principios que guían cada decisión y desarrollo en UlissesDS",
    value1: {
      title: "Precisión",
      description:
    ...
    value2: {
      title: "Empatía",
      description: "Tecnología centrada en el bienestar del paciente",
    },
    value3: {
      title: "Innovación",
      description: "Investigación continua en IA y aprendizaje automático",
    },
    value4: {
      title: "Colaboración",
      description: "Trabajo conjunto con la comunidad médica global",
    },
  },
  story: {
